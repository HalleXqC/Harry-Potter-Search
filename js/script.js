...
function showCards(arr){
    const cards = arr.map(({name, species, gender, faculty, actor, image}) => {
        return `
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-4 item card_item">
                ...
                <div class="card-body">
                    ...
                    <div class="card-body-back">
                        <h5>Информация Info Информация Info Информация Info Информация Info Информация Info Информация Info Информация Info Информация Info Информация Info Информация Info Информация Info Информация Info Информация Info Информация Info</h5>
                        <a href="https://en.wikipedia.org/wiki/${actor}" target="_blank">About Actor</a>
                        <button class="addFav"><i class="far fa-heart heartLogo"></i></button>
                    </div>
                </div> 
            </div>
        `
